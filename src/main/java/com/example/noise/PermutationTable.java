...
public class PermutationTable {
    ...
    private static final int[] DEFAULT_PERMUTATION_TABLE = {
        ...
        2,44,154,163,70,221,153,101,155,167,43,172,9,129,22,39,253,9,98,108,110,79,113,224,232,178,185,
    ...
    // This method handles the modulo for the outer index and relies on p being doubled
    // to handle the inner sums without further modulos IF the sums stay within 0 to 2*period-1.
    ...
    // Max value of perm[x] is period-1. So ii + perm[jj] < period + (period-1) < 2*period.
