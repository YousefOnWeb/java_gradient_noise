 ...
 * for fast "fake noise" implementation in GLSL for execution in shaders.
 *
 * Based on Python package 'noise' by Casey Duncan.
 */
public class Noise {

    public static final String VERSION = "1.2.1 (Java port)";
    ...
    // One can create specific PermutationTable instances and pass to noise functions for varied results or specific seeds.
    ...
    // Add more overloads if custom persistence, lacunarity, or perm_table is needed at this level
